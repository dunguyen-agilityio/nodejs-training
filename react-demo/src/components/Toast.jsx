...
export default function Toast({ message, type = 'info', duration = 3000, onClose }) {
  ...
  return (
    <div
      className={`fixed top-4 right-4 z-50 max-w-md border rounded-lg p-4 shadow-lg animate-slide-in ${typeStyles[type]}`}
      role="alert"
    >
      <div className="flex items-start gap-3">
        <span className={iconColor[type]}>{icons[type]}</span>
